...
public class BalaDetilas extends BaseClass {
	@BeforeClass
	...
	public void testCase() throws IOException, InterruptedException {
	    ...
	    fill(s.getSearchbox(), "builder");
		btnclick(s.getGo());
		stawait(3000);
		WebElement java = driver.findElement(By.xpath("(//span[text()='£14'])[1]"));
		createdata(4, 5, java.getText());
		createdata(4, 6, "59%");
